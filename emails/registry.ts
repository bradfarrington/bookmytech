...
export const EMAIL_TEMPLATE_DEFS: readonly EmailTemplateDef[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { id: "report", type: "custom", render: "report_link" },
  ...
  // ─── Quotes for extra work (Task 33) ────────────────────────────────────
  {
    ...
    category: "customer",
    subject: "Your mechanic has sent a quote",
    preheader: "Review and approve the extra work your mechanic has quoted for.",
    variables: [
      { name: "name", description: "Customer's name", example: "Alex" },
      ...
      { name: "kind_line", description: "What the quote is for", example: "extra work on your current job" },
      { name: "quote_lines", description: "Packed list of lines (a|b|c)", example: "Renew the rear brake pads · 0.8 h × £60.00 = £48.00|Rear brake pads · £32.00" },
      { name: "optional_note", description: "Mechanic's note (if any)", example: 'Note from your mechanic: "The rear pads are down to the metal."' },
      { name: "url", description: "Link to review the quote", example: "https://bookmytech.co.uk/dashboard/quotes/…" },
      { name: "expires", description: "When the quote lapses", example: "Tuesday 15 September" },
    ],
    blocks: [
      { id: "heading", type: "heading", text: "A quote from your mechanic" },
      { id: "greeting", type: "paragraph", text: "Hi {{name}}," },
      { id: "body", type: "paragraph", text: "{{mechanic}} has quoted **{{total}}** for {{kind_line}} on job {{ref}}:" },
      { id: "lines", type: "custom", render: "quote_lines" },
      { id: "note", type: "custom", render: "optional_note" },
      { id: "cta", type: "button", text: "Review and approve", hrefVar: "url" },
      {
        id: "footnote",
        type: "note",
        text: "Nothing is charged until you approve. Work only goes ahead once you have. This quote is open until {{expires}}.",
      },
    ],
  },
  {
  ...
  {
    key: "quote_declined_mechanic",
    label: "Quote declined (to mechanic)",
    description: "Sent to the mechanic when the customer declines their quote.",
    category: "mechanic",
    subject: "Your quote was declined",
    preheader: "The customer didn't go ahead with the extra work.",
    variables: [
      { name: "ref", description: "Job number", example: "00123" },
      { name: "total", description: "Quote total", example: "£87.00" },
      { name: "kind_line", description: "What the quote was for", example: "extra work on this visit" },
  ...
  {
    key: "quote_expired_mechanic",
    label: "Quote expired (to mechanic)",
    description: "Sent to the mechanic when a quote lapsed unanswered.",
    category: "mechanic",
    subject: "Your quote expired",
    preheader: "The customer didn't answer in time.",
    variables: [
      { name: "ref", description: "Job number", example: "00123" },
      { name: "total", description: "Quote total", example: "£87.00" },
      { name: "kind_line", description: "What the quote was for", example: "a return visit" },
    ],
    blocks: [
      { id: "heading", type: "heading", text: "Quote expired" },
      { id: "body", type: "paragraph", text: "Your **{{total}}** quote for {{kind_line}} on job {{ref}} lapsed without an answer. You can send a new one from the job." },
      { id: "footnote", type: "note", text: "View it on your dashboard." },
    ],
  },
  // ─── Revised job on site (Task 37) ───────────────────────────────────────
  {
    ...
    variables: [
      ...
      { name: "optional_note", description: "Mechanic's note (if any)", example: "" },
      { name: "url", description: "Link to review the revised job", example: "https://bookmytech.co.uk/dashboard/revisions/…" },
      { name: "expires", description: "When it lapses", example: "Wednesday 14:05" },
    ],
    blocks: [
      { id: "heading", type: "heading", text: "The repair you booked isn't what your car needs" },
      { id: "greeting", type: "paragraph", text: "Hi {{name}}," },
      { id: "body", type: "paragraph", text: "{{mechanic}} has looked at your car on job {{ref}} and says: \"{{reason}}\"" },
      { id: "diff", type: "custom", render: "revision_diff" },
      { id: "money", type: "paragraph", text: "{{difference_line}}" },
      { id: "note", type: "custom", render: "optional_note" },
      { id: "cta", type: "button", text: "Review the revised job", hrefVar: "url" },
      {
        id: "footnote",
        type: "note",
  ...
  {
    key: "revision_approved_mechanic",
  ...
  {
    key: "revision_declined_mechanic",
    label: "Revised job declined (to mechanic)",
    description: "Sent to the mechanic when the customer declines the revised job.",
    category: "mechanic",
    subject: "The revised job was declined",
    preheader: "Don't carry out that work.",
    variables: [
      { name: "ref", description: "Job number", example: "00123" },
      { name: "job", description: "The revised job", example: "Renew the front wheel bearing" },
      { name: "after_total", description: "The revised total", example: "£111.00" },
  ...
  {
    key: "revision_expired_mechanic",
    label: "Revised job expired (to mechanic)",
    description: "Sent to the mechanic when a revised job lapsed unanswered.",
    category: "mechanic",
    subject: "Your revised job expired",
    preheader: "The customer didn't answer in time.",
    variables: [
      { name: "ref", description: "Job number", example: "00123" },
      { name: "job", description: "The revised job", example: "Renew the front wheel bearing" },
    ...
    blocks: [
      { id: "heading", type: "heading", text: "Revised job expired" },
      { id: "body", type: "paragraph", text: "The revised job on {{ref}} ({{job}}, {{after_total}}) lapsed without an answer. You can send it again from the job, or end the job." },
      { id: "footnote", type: "note", text: "View it on your dashboard." },
    ],
  },
  {
    ...
    preheader: "The repair you booked wasn't what your car needed.",
    variables: [
      { name: "name", description: "Customer's name", example: "Alex" },
      { name: "ref", description: "Job number", example: "00123" },
