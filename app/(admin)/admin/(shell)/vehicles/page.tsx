...
// covers, drill into models and engine variants, and manage per-model repair
// availability (hides for every vehicle live under Repairs — Task 23) +
// eyeball the technical data behind vehicle-specific pricing.
    ...
    <div className="space-y-6">
      <header>
        ...
        <p className="mt-1.5 max-w-2xl text-sm text-text-muted">
          ...
          which repairs are bookable on that model, check the OEM repair times
          behind vehicle-specific pricing, and browse manuals and technical
          data. To hide a repair for every vehicle, use Repairs.
        </p>
      </header>
