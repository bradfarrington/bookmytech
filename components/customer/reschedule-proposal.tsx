        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <button
              ...
              className="inline-flex h-10 items-center gap-1.5 rounded-button bg-brand-blue px-4 text-sm font-semibold text-white transition-colors hover:bg-brand-blue-dark disabled:cursor-not-allowed disabled:opacity-50"
            >
              <Check size={15} />
              Accept new time
            </button>
            <button
              ...
              className="inline-flex h-10 items-center gap-1.5 rounded-button border border-amber-300 bg-white px-4 text-sm font-semibold text-amber-900 transition-colors hover:bg-amber-100 disabled:cursor-not-allowed disabled:opacity-50"
            >
              <X size={15} />
              Keep original
            </button>
