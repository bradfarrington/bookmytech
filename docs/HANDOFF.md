...
**Next up: Task 07 — Mechanic onboarding** (`docs/tasks/07-mechanic-onboarding.md`). Read the task doc before starting. ⚠️ Set **`NEXT_PUBLIC_SITE_URL`** in prod so review-email links resolve.
