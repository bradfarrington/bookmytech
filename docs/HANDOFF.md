...
Still open for the **real mobile build**: PWA shell + install, push notifications, offline IndexedDB sync, GPS live-location, and the Me tab. Read the task doc before continuing.
