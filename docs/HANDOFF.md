...
**Next up: Task 08 — Pricing & Stripe Connect** (`docs/tasks/08-pricing-and-stripe-connect.md`). Read the task doc before starting. This is also where the **partial-deposit model** and **mechanic payouts** land.
